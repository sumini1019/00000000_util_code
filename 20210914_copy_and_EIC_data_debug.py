...
# 복사할 경로
resultPath_eic = r'Z:\Stroke\SharingFolder\20210915_cELVO_길병원_학습용데이터\used_for_dms_2'
...
for i in range(0, len(df)):
    ...
    try:
        shutil.copy(path_file_left,
                    os.path.join(resultPath_eic, name_file_left.replace('HR_', 'HR-')))
        # shutil.copy(path_file_left,
    ...
    # Right도 똑같이 적용
    try:
        shutil.copy(path_file_right, os.path.join(resultPath_eic, name_file_right))
