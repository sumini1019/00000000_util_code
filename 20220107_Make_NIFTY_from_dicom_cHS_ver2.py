# 2022.08.30
# - 기존 Nifti 변환 코드 기반으로 변형하는거 실패ㅐㅐㅐㅐㅐㅐㅐㅐㅐㅐㅐㅐㅐㅐㅐㅐㅐㅐㅐㅐㅐ
# - 다른 패키지 가지고 시도
...
dicom2nifti.convert_directory(os.path.join(image_directory, list_patient_folder[0]), r'C:\Users\user\Downloads\새 폴더 (5)')
...
#     # print('Series_ID (Image) : ', series_ID)
#     # series_file_names = sitk.ImageSeriesReader.GetGDCMSeriesFileNames(path, series_ID[0])
#     series_file_names = os.listdir(path)
