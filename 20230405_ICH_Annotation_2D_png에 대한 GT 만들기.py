...
for index, item in enumerate(list_slice):
    print(f'Processing index: {index} / {len(list_slice)-1}', end='\r')
...
df.to_csv(os.path.join(path_save, f'20230717_GT_ICH_Annotation_Slicewise_n{len(df)}_6차수령데이터까지.csv'), index=False)